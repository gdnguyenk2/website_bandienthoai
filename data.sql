...
(
    ...
    DaThanhToan NVARCHAR(50) NOT NULL,
...
(
    MaQuangCao INT IDENTITY NOT NULL,
...
(1, N'Admin', N'123456', N'Admin', N'An Tân, Thái Thụy, Thái Bình', N'admin@gmail.com', '0123456789', null, null),
(2, N'ThanhLong', N'123456', N'Thanh Long', N'An Tân, Thái Thụy, Thái Bình', N'longlonton110@gmail.com', '05725756331', null, null),
(2, N'TaiLe', N'123456', N'Lê Hữu Tài', N'Số nhà 123, Xã Dĩ An, Huyện Dĩ An, Tỉnh Bình Dương', N'lehuutai09@gmail.com', '0324195842', null, null),
(2, N'ThanhThao', N'123456', N'Nguyễn Thị Thanh Thảo', N'Số 1, Đinh Tiên Hoàng, Quận Hoàn Kiếm, Thành phố Hà Nội', N'thanhthaonopro@gamil.com', '0342594124', null, null),
(2, N'CongHuy', N'123456', N'Huỳnh Công Huy', N'Số 58, Phố Nguyễn Du, Quận Hai Bà Trưng, Thành phố Hà Nội', N'conghuyhuynh1610@gmail.com', '0942943054', null, null)
GO
...
(N'Không có', N'Không', 0, '2024-04-20', '2024-04-30'),
(N'Khuyễn mãi đợt 1 cho iPhone', N'Khuyến mãi 5% cho Iphone', 5, '2024-05-20', '2024-05-30'),
(N'Khuyến mãi đợt 2 cho Samsung', N'Khuyến mãi 10% cho Samsung', 10, '2024-05-20', '2024-05-30'),
(N'Khuyến mãi đợt 3 cho tai nghe', N'Khuyến mãi 15% cho tai nghe', 15, '2024-05-20', '2024-05-30'),
(N'Khuyến mãi đợt 4 cho sạc dự phòng', N'Khuyến mãi 20% cho tai nghe', 20, '2024-05-20', '2024-05-30')
GO
...
(7, 30, 239000, 10)
GO
INSERT INTO QuangCao(TenQC,HinhAnh,NgayCapNhat) VALUES
(N'Quang Cao 1',N'quangcao1.jpg','2024-03-01'),
(N'Quang Cao 2',N'quangcao2.png','2024-03-01'),
